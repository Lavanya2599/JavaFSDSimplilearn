...
<html>
<head>
    <title>Doctor Home Page - Vital Management</title>
...
<body>
    <h1>Doctor Home Page - Vital Management</h1>
    <div class="header">
       ...
       <input type="hidden" name="patientid" value="<%= request.getParameter("patientid")%>">
        ...
        <form action="vitalalerts.jsp" method="post">
            <button type="submit" class="action-btn">View Alerts</button>
        </form>
        ...
        <table>
            ...
            <%  
                try {
                    ...
                    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/health", "root", "master");
